...
return [
    ...
    */
    ...
    'visits_updated_fetch_all_url' =>  $base_url . 'visits_updated_fetch_all.php',
    'tour_plan_visits_details_url' =>  $base_url . 'tour_plan_visits_details.php',
    'expenses_add_url' =>  $base_url . 'expenses_add.php',
    'expenses_fetch_url' =>  $base_url . 'expenses_fetch.php',
    'expenses_delete_url' =>  $base_url . 'expenses_delete.php',
    'bloodbanks_by_city_url' => $base_url . 'bloodbanks_by_city.php?cityIds={cityIds}',
    'reports_blood_banks_summary_url' =>  $base_url . 'reports_blood_banks_summary.php',
    'reports_user_wise_collection_summary_url' =>  $base_url . 'reports_user_wise_collection_summary.php',
