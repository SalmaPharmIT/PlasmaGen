...
<div class="pagetitle">
  ...
  <section class="section">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Edit Blood Bank</h5>
            ...
            <!-- Entity Edit Form -->
            <form class="row g-3" action="{{ route('bloodbank.update', $entity['id']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="FFP_procurement_company" name="FFP_procurement_company" value="{{ old('FFP_procurement_company', $entity['FFP_procurement_company']) }}" required>
                </div>

                <!--Final Accepted Offer -->
                <div class="col-md-6">
                    <label for="final_accepted_offer" class="form-label">Final Accepted Offer <span style="color:red">*</span></label>
                    <input type="text" class="form-control" id="final_accepted_offer" name="final_accepted_offer" value="{{ old('final_accepted_offer', $entity['final_accepted_offer']) }}" required>
                </div>

                 <!--Payment Terms -->
                 <div class="col-md-6">
                    <label for="payment_terms" class="form-label">Payment Terms <span style="color:red">*</span></label>
                    <input type="text" class="form-control" id="payment_terms" name="payment_terms" value="{{ old('payment_terms', $entity['payment_terms']) }}" required>
                </div>
                ...
                <!-- Entity Customer Care No -->
                <div class="col-md-6">
                    <label for="entity_customer_care_no" class="form-label">Entity Customer Care No <span style="color:red">*</span></label>
                    <input type="text" class="form-control" id="entity_customer_care_no" name="entity_customer_care_no" value="{{ old('entity_customer_care_no', $entity['entity_customer_care_no']) }}" required>
                </div>
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('bloodbank.index') }}" class="btn btn-secondary">Cancel</a>
                </div>
