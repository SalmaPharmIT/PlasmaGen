...
<style>
    ...
    .sub-mini-pool-volume {
        border: none !important;
        background: transparent !important;
        text-align: right !important;
        padding: 0 4px !important;
    }
    .sub-mini-pool-volume:focus {
...
<div class="pagetitle">
    <h1>Sub Mini Pool Bag Entry</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Sub Mini Pool Bag Entry</li>
        </ol>
    </nav>
</div>
    ...
    try {
        ...
        $(document).ready(function() {
                                ...
                                if (response.data.details && response.data.details.length > 0) {
                                    ...
                                    response.data.details.forEach((detail, index) => {
                                        ...
                                        if (currentSubMiniPool !== detail.sub_mini_pool_number) {
                                            ...
                                            html += `<td class="p-0 text-center" rowspan="${subMiniPoolRowspan}">
                                                <input type="text" step="0.01" class="form-control sub-mini-pool-volume" 
                                                    name="sub_mini_pool_volume[${detail.sub_mini_pool_number}]" 
                                                    value="" 
                                                    required>
                                            </td>`;
            ...
            $('#subMiniPoolForm').on('submit', function(e) {
                ...
                // Calculate total volume before submission
            ...
            // Add function to calculate total volume
            function calculateTotalVolume() {
                let total = 0;
                $('.sub-mini-pool-volume').each(function() {
            ...
            // Add event listener for volume input changes
            $(document).on('input', '.sub-mini-pool-volume', function() {
                calculateTotalVolume();
            });

            // Add validation for volume inputs
            $(document).on('change', '.sub-mini-pool-volume', function() {
